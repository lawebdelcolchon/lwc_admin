...
function InternalPage(){
    ...
    const icons = [
        { icon: HiOutlineArrowLeftStartOnRectangle, message: 'Devolver Pedido' },
        { icon: HiOutlineArrowUturnLeft, message: 'Quitar procesado' },
    ...
    return(
        <EntityList 
            ...
            query={[{
                ...
                pivotTable: 'gt_global_order_supplier',
                whereCondition: '',
